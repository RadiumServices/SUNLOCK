...
NotifyLib.prompt('SUN LOCK', 'KILL THEM FAGZ', 5)
NotifyLib.prompt('SUN LOCK', '$un#3554', 5)
...
local PredictionValue = 0.1202938
    ...
    function noob(player)
        ...
        local handler = makemarker(guimain, player.Character:WaitForChild(SelectedPart), Color3.fromRGB(69, 117, 32), 0.3, 3)
